...
UUID=${UUID:-'894df7ef-157c-4540-b58d-6703dcc1cb2b'}
VMESS_WSPATH=${VMESS_WSPATH:-'/yydpz-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/yydpz-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/yydpz-trojan'}
